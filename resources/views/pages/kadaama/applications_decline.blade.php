        ...
        <div class="row">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{url("kadaama/applications/decline/".$application->id."/save")}}" method="post" enctype="multipart/form-data">
                        @csrf

                        <div class="form-group mb-2">
                            <label for="exampleInputEmail1">Review/Reason for Declining</label>
                            <textarea class="form-control" name="review" id="exampleInputEmail1" style="height: 500px"></textarea>
                        </div>
