                ...
                <div class="card-body row">
                    ...
                    @if($application->status == "pending")
                        <div class="col-12">
                            <hr>
                            <h5>Actions</h5>
                            <a href="{{url("/kadaama/applications/accept/".$application->id)}}" class="btn btn-success">Accept Application</a>
                            <a href="{{url("/kadaama/applications/decline/".$application->id)}}" class="btn btn-danger">Decline Application</a>
                        </div>
                    @elseif($application->status == "processing")
                        <div class="col-12">
                            <hr>
                            <h5>Actions</h5>
                            <a href="{{url("/kadaama/applications/approve/".$application->id)}}" class="btn btn-success">Approve Application</a>
                            <a href="{{url("/kadaama/applications/decline/".$application->id)}}" class="btn btn-danger">Decline Application</a>
                        </div>
                    @endif
