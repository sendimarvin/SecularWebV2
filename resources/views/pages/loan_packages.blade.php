...
@section('content')
    <div class="container-fluid px-4">
        <h1 class="mt-4">Loan Packages</h1>
            ...
            <div class="card-body">
                <table id="example" 
                    ...
                    <tbody>
                        ...
                        @foreach ($loan_packages as $package)
                            <tr>
                                <td>{{ $package->id }}</td>
                                <td>{{ $package->loan }}</td>
                            </tr>
                ...
                "buttons": [
                    {
                        ...
                        action: function ( e, dt, node, config ) {
                            window.location.href='/loans/new_package'
                        }
                    },
                    {
                        text: 'Edit',
                        action: function ( e, dt, node, config ) {
                            ...
                            window.location.href='/loans/edit_package/'+row[0]
                        }
                    },
                    {
                        text: 'Delete',
                        action: function ( e, dt, node, config ) {
                            ...
                            let row = $('#example').DataTable().row('.selected').data();
                            let idtodelete = row[0];
                            window.location.href='/loans/delete_package/'+row[0]
                        }
                    },
                    {
                        text: 'Excel',
