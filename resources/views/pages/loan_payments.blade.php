                    ...
                    <tbody>
                        ...
                        @foreach ($loan_payments as $loan_payment)
                            <tr>
                                ...
                                <td>{{ $loan_payment->application_id }}</td>
                                <td>{{ $loan_payment->payment_method }}</td>
                                <td>{{ $loan_payment->payment_date }}</td>
                                <td>{{ $loan_payment->title }}</td>
                                <td>{{ $loan_payment->amount }}</td>
                                <td>{{ $loan_payment->payment_ref }}</td>
                                <td>{{ $loan_payment->firstName }} {{ $loan_payment->middleName }} {{ $loan_payment->lastName }}</td>
                                <td>{{ $loan_payment->phoneNumber }}</td>
                                <td>{{ $loan_payment->approval_status }}</td>
                                <td>{{ $loan_payment->approval_date }}</td>
                            </tr>
                        @endforeach
