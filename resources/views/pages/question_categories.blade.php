...
@section('content')
    <div class="container-fluid px-4">
        <h1 class="mt-4">Questions Category</h1>
                ...
                "buttons": [
                    {
                        ...
                        action: function ( e, dt, node, config ) {
                            ...
                            window.location.href='/question/new_category'
                        }
                    },
                    {
                        text: 'Edit',
                        action: function ( e, dt, node, config ) {
                            ...
                            window.location.href='/question/edit_category/'+row[0]
                        }
                    },
                    {
                        text: 'Delete',
                        action: function ( e, dt, node, config ) {
                            ...
                            let row = $('#example').DataTable().row('.selected').data();
                            let idtodelete = row[0];
                            window.location.href='/question/delete_category/'+row[0]
                        }
                    },
                    {
                        text: 'Excel',
